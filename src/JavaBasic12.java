public class JavaBasic12 {
    public static void main(String[] args) {
        ...
        System.out.print("Removing letter s from the sentence : ");
        ...
        System.out.print("Removing special characters from the sentence  : ");
        ...
        System.out.print("Replacing dollar sign to pounds : ");
        System.out.println(price.replaceAll("\\$", "£"));//replacing dollar sign to pounds
        System.out.print("Extracting middle letter from word There :  ");
        System.out.println(word1); //middle letter e from word There
        System.out.print("Extracting letter l from word England  :  ");
        System.out.println(word2);//letter l from word england
        System.out.print("Getting letter an from word orange :  ");
